...
void display(void)
{
 ...
 glLoadName(TEXTID);
 glColor3f(1,1,0);
 DrawTextXY(-2.5,0.2,2.0,0.0015,"4VM20CS009");
 DrawTextXY(-2.5,0.5,2.0,0.0015,"AYAN");
 DrawTextXY(2.5,2.2,-2.0,0.0025,"4VM20CS018");
 DrawTextXY(2.5,2.7,-2.0,0.0030,"CHANDRASHEKAR");
  glFlush();
  glutSwapBuffers();
